...
async function startTypewriter() {
  ...
  await typeWriter(p3, "No hablo de conspiraciones. No hay un grupo de señores gordos y forrados en una sala oscura decidiendo qué va a ser de tu vida. Es peor que eso", 50);
   await typeWriter(p4, "¿Crees que un título universitario te hace más válido? ¿Crees que todos los ricos son malas personas? ¿Crees que hipotecarte te da estabilidad? ¿Crees que ser funcionario es tener la vida resuelta? ¿Crees que está mal querer más de lo que tienes? No juzgo tu respuesta, pregunto si alguna vez llegaste a esas conclusiones por tu propia cuenta.", 50);
