                          ...
                          <form class="ml-block-form"
                              ...
                              <div class="ml-form-fieldRow ml-last-item">
                                <div class="ml-field-group ml-field-email ml-validate-email ml-validate-required">
                                  ...
                                  <input aria-label="email" aria-required="true" type="email" class="form-control" data-inputmask=""
                                    name="fields[email]" placeholder="✉️ tucorreo@email.com" autocomplete="email">
                                  <!-- /input -->
                            ...
                            <div class="ml-form-embedPermissions">
                              ...
                              <p> <!-- #mlb2-27786331.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-embedPermissions .ml-form-embedPermissionsContent.privacy-policy p -->
                                Puedes leer las burocráticas políticas de privacidad <a href="/privacidad" target="_blank" style="color: #a6a6a6;">aquí</a>
                              </p>
...
async function startTypewriter() {
  ...
  await typeWriter(p4, "No hablo de conspiraciones. No hay un grupo de señores gordos y forrados en una sala oscura decidiendo qué va a ser de tu vida. Es peor que eso. ¿Crees que lo seguro es trabajar de 9 a 5 e hipotecarse? ¿Crees que vender es estafar? ¿Crees que todos los ricos son malas personas?  ¿Crees que está mal querer más de lo que tienes? No juzgo tu respuesta, pregunto si alguna vez llegaste a esas conclusiones por tu propia cuenta.", 50);
  await typeWriter(p5, "Imagina que plantas un árbol en una maceta pequeña. El árbol crece, pero las raíces no tienen donde ir. Se enroscan sobre sí mismas, se asfixian. El árbol sobrevive pero nunca crece más allá de lo que la maceta permite. Ahora visualiza la maceta como los discursos que nos rodean desde que nacemos.", 50);
  await typeWriter(p6, "¿Cómo se sale de la maceta? Yo no tengo todas las respuestas. Aunque siempre busco las mejores preguntas. Toda la vida, desde que fui un niño preguntón dando la turra. El problema hoy en día es que los algoritmos no buscan darte libertad, buscan mantenerte enganchado con dopamina rápida y scroll infinito. Nosotros somos su producto. Pero hay esperanza. Si has tenido la iniciativa de leer todo esto es porque alguna vez viste alguno de mis vídeos. Para que eso pasara tuve que aprender sus reglas, llevo desde 2018 trabajando con redes sociales e influencers. Sé cómo funcionan por dentro. Pero saber jugar su juego no significa que sea el lugar para decir lo más importante.", 50); 
  await typeWriter(p7, "Compartir ideas con naturalidad solo es posible si hablamos de tú a tú. Lo ideal sería un medio sin tecnología siquiera, enviarte una carta en papel: Llega a tus manos un sobre oscuro (muy elegante) con una barrabaja dorada en el centro. Al abrirlo lees de mi puño y letra lo que te quiero contar... Pero hacerlo así es inviable, claro. Lo más parecido es poder enviarte un correo.", 70);
